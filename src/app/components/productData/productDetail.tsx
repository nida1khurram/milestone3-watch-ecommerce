...
export default function ProductDetail() {
  return (
    <div>
        <div className='w-[1110px] mx-auto mb-5'>
            <ul className={`${taviraj.className} flex gap-14 text-[20px] font-semibold text-[#999999]`}
           >
      ...
      <div className='w-[1046px] ml-28'>
        ...
        <p className={`${nunito.className}  h-[84px] text-pretty leading-relaxed text-[16px] text-[#555555]`}>
        ...
        <h2 className={`${taviraj.className} text-[24px] text-mygray leading-loose`}>
        Dial</h2>
          <p className={`${nunito.className} text-pretty leading-relaxed text-[16px] text-[#555555]`}>
